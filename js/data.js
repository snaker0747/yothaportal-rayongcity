...
const portalConfig = {
  municipalityName: "เทศบาลนครระยอง จังหวัดระยอง",
  departmentName: "ฝ่ายสาธารณูปโภค ส่วนการโยธา สำนักการช่าง",
  portalTitle: "ศูนย์รวมระบบงาน",
  portalSubtitle: "ระบบสารสนเทศและดิจิทัลแพลตฟอร์มเพื่อการบริหารจัดการและติดตามงานช่าง",
  logoUrl: "assets/images/logo.png",
  contactInfo: {
    phone: "038-xxx-xxx",
    location: "สำนักการช่าง เทศบาลนครระยอง",
...
const systemsData = [
  ...
  },
  {
    ...
    department: "ส่วนการโยธา สำนักการช่าง",
